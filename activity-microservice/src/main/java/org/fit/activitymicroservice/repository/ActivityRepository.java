...
public interface ActivityRepository extends JpaRepository<Activity,Integer> {
    ...
    @Query(nativeQuery = true, value = "select * from fitness_tracker.activity where employee_id = :employeeId and date between :startDate and :endDate")
    ...
    @Query(nativeQuery = true, value = "select * from fitness_tracker.activity where employee_id = :employeeId ")
    List<Activity> getEmployeeActivitiesWithoutRange(@Param("employeeId") String employeeId);

    @Query(nativeQuery = true, value = "select * from fitness_tracker.activity where activity_name = :activityName and date between :startDate and :endDate")
    ...
    @Query(nativeQuery = true, value = "delete from fitness_tracker.activity where employee_id = :employeeId and date between :startDate and :endDate")
